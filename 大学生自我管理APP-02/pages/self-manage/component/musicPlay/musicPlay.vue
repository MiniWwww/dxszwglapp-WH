		...
		<view class="bgfff">
			<view>
				<view class="audo-video">
					...
					<view class="audo-top">
						<!--上一首切换按钮-->
						<image v-if="jian" style="width:50rpx;height:50rpx;" @click="nosig" src="../../../../static/上一首.png" mode="aspectFill"></image>
						<image v-else @click="sig" src="../../../../static/下一首.png" style="width:50rpx;height:50rpx;transform:rotate(180deg)"
							mode="aspectFill"></image>
						<!--上一首切换按钮-->

						<!--快退按钮-->
						<image src="../../../../static/快退.png" style="width:45rpx;height:45rpx;" mode="aspectFill" @click="kt()"></image>
						<!--快退按钮-->

						<!--播放按钮-->
						<image :src="succes?'../../../../static/播放2.png':'../../../../static/暂停.png'" mode="aspectFill"
							style="width:180rpx;height:180rpx;" @click="plays()"></image>
						<!--播放按钮-->

						<!--快进按钮-->
						<image src="../../../../static/快进.png" style="width:45rpx;height:45rpx;" mode="aspectFill" @click="kj()"></image>
						<!--快进按钮-->

						<!--下一首切换按钮-->
						<image v-if="jia" @click="noxig" style="width:50rpx;height:50rpx;transform:rotate(180deg)" src="../../../../static/上一首.png"
							mode="aspectFill"> </image>
						<image v-else style="width:50rpx;height:50rpx;" src="../../../../static/下一首.png" @click="xig" mode="aspectFill"></image>
						<!--下一首切换按钮-->
					</view>
					<!--音频播放按钮处-->
	...
	*/
	export default {
		...
		mounted() {
			...
			//         this.$emit('childmethod', function() {
			//         that.num=0;
			// 		that.recorPath=that.list[0];
			// 		that.succes=false;
			// 		console.log(that.recorPath)
			// 		that.plays();
			// 	});
			// });
		...
		methods: {
			clickit(index){
				...
				if(index==this.num){
					...
					//#ifdef H5
					this.$refs.myVideo.seek(0) //获取秒数
					//#endif
					//#ifndef H5
					this.videoContext.seek(0) //获取秒数
					//#endif
				}
			},
			sendMsg(){
